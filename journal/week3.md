...
| TASK | COMPLETED |
|  --- |    ---    |
| Watch Week 3 Live-Stream Video | :heavy_check_mark: |
| Watched Ashish's Week 3 - Decenteralized Authentication | :heavy_check_mark: |
| Provision via ClickOps a Amazon Cognito User Pool | :heavy_check_mark: |
| Install and configure Amplify client-side library for Amazon Congito | :heavy_check_mark: |
| Instrument AWS X-Ray Subsegments | :heavy_check_mark: |
| Implement API calls to Amazon Coginto for custom login, signup, recovery and forgot password page | :heavy_check_mark: |
| Verify JWT Token server side to serve authenticated API endpoints in Flask Application | :heavy_check_mark: |
